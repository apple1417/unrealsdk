#ifndef UNREALSDK_UNREAL_PROPERTIES_ZDELEGATEPROPERTY_H
#define UNREALSDK_UNREAL_PROPERTIES_ZDELEGATEPROPERTY_H
...
#endif /* UNREALSDK_UNREAL_PROPERTIES_ZDELEGATEPROPERTY_H */
