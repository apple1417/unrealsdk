#ifndef UNREALSDK_UNREAL_PROPERTIES_ZMULTICASTDELEGATEPROPERTY_H
#define UNREALSDK_UNREAL_PROPERTIES_ZMULTICASTDELEGATEPROPERTY_H
...
#endif /* UNREALSDK_UNREAL_PROPERTIES_ZMULTICASTDELEGATEPROPERTY_H */
