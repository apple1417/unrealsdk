...
#define UNREALSDK_USTRUCT_PROPERTY_ITER_PROPERTYLINK 1
#define UNREALSDK_USTRUCT_PROPERTY_ITER_CHILDPROPERTIES 2

#define UNREALSDK_FTEXT_FORMAT_NOT_IMPLEMENTED 0
#define UNREALSDK_FTEXT_FORMAT_TSHAREDPTR 1
#define UNREALSDK_FTEXT_FORMAT_RAW_PTR 2
...
#define UNREALSDK_PROPERTIES_ARE_FFIELD false
...
#define UNREALSDK_GOBJECTS_FORMAT UNREALSDK_GOBJECTS_FORMAT_TARRAY
#define UNREALSDK_USTRUCT_PROPERTY_ITER UNREALSDK_USTRUCT_PROPERTY_ITER_PROPERTYLINK
#define UNREALSDK_FTEXT_FORMAT UNREALSDK_FTEXT_FORMAT_NOT_IMPLEMENTED

#define UNREALSDK_ZBOOLPROPERTY_FIELD_MASK_TYPE uint32_t
#define UNREALSDK_UOBJECT_FLAGS_TYPE uint64_t
#define UNREALSDK_ZPROPERTY_FLAGS_TYPE uint32_t
...
#define UNREALSDK_USTRUCT_PROPERTY_ITER UNREALSDK_USTRUCT_PROPERTY_ITER_PROPERTYLINK
#define UNREALSDK_FTEXT_FORMAT UNREALSDK_FTEXT_FORMAT_TSHAREDPTR

#define UNREALSDK_ZBOOLPROPERTY_FIELD_MASK_TYPE uint8_t
#define UNREALSDK_UOBJECT_FLAGS_TYPE uint32_t
#define UNREALSDK_ZPROPERTY_FLAGS_TYPE uint64_t
...
#define UNREALSDK_HAS_OPTIONAL_FUNC_PARAMS false
#define UNREALSDK_USTRUCT_HAS_ALIGNMENT true
#define UNREALSDK_PROPERTIES_ARE_FFIELD true

#define UNREALSDK_ENUM_FORMAT UNREALSDK_ENUM_FORMAT_UE4
#define UNREALSDK_FIMPLEMENTEDINTERFACE_FORMAT UNREALSDK_FIMPLEMENTEDINTERFACE_FORMAT_UE4
#define UNREALSDK_GOBJECTS_FORMAT UNREALSDK_GOBJECTS_FORMAT_FUOBJECTARRAY
#define UNREALSDK_USTRUCT_PROPERTY_ITER UNREALSDK_USTRUCT_PROPERTY_ITER_PROPERTYLINK
#define UNREALSDK_FTEXT_FORMAT UNREALSDK_FTEXT_FORMAT_RAW_PTR
